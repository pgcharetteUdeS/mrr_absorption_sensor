...
%PYTHONDIR%/python.exe mrr_absorption_sensor_vs_spiral.py --in_data_file "Tableau_Pauline_h03_TE.toml"
REM %PYTHONDIR%/python.exe mrr_absorption_sensor_vs_spiral.py --in_data_file "Tableau_Theo_h03_TE.toml"
pause
