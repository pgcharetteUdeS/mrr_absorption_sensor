...
Data read from files generated by the mrr_absorption_sensor package:
    - "<mantissa>_2DMAPS_VS_GAMMA_and_R.xlsx" and
...
def _determine_y_plotting_extrema(
    ...
    """
    Determine the maximum values of Smax and alpha*L in the Workbooks
...
def _figure_6(
    ...
    """
    Plot and save alpha*L, alpha_prop*L, alpha_bend*L, at a list of gamma values
